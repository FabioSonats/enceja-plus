...
class PredefinedMathGames {
  static final List<MathGame> games = [
    ...
    // NÍVEL 5 - QUEBRA-CABEÇA MATEMÁTICO
    MathGame(
      id: 'math_puzzle',
      title: 'Quebra-Cabeça Matemático',
      description: 'Resolva quebra-cabeças com números e operações',
      ...
      questions: [
        MathQuestion(
          id: 'puzzle_1',
          question: 'Complete a sequência: 2, 4, 6, ?, 10',
          options: ['7', '8', '9', '12'],
          correctAnswer: '8',
          explanation: 'A sequência aumenta de 2 em 2: 2, 4, 6, 8, 10',
          timeLimit: 60,
          points: 20,
          type: MathGameType.puzzle,
        ),
        MathQuestion(
          id: 'puzzle_2',
          question: 'Qual número falta? 3 + ? = 7',
          options: ['3', '4', '5', '6'],
          correctAnswer: '4',
          explanation: '3 + 4 = 7',
          timeLimit: 60,
        ...
        MathQuestion(
          id: 'puzzle_4',
          question: 'Qual é o próximo número? 1, 4, 9, 16, ?',
          options: ['20', '24', '25', '30'],
          correctAnswer: '25',
          explanation: 'São quadrados perfeitos: 1², 2², 3², 4², 5² = 25',
          timeLimit: 60,
          points: 20,
          type: MathGameType.puzzle,
        ),
    ...
    // NÍVEL 6 - PALAVRAS CRUZADAS MATEMÁTICAS
    MathGame(
      id: 'math_crossword',
      title: 'Palavras Cruzadas Matemáticas',
      description: 'Resolva palavras cruzadas com termos matemáticos',
      ...
      questions: [
        MathQuestion(
          id: 'crossword_1',
          question: 'Operação que representa "juntar" (5 letras)',
          options: ['SOMA', 'MENOS', 'VEZES', 'DIVIDE'],
          correctAnswer: 'SOMA',
          explanation: 'A soma é a operação de juntar quantidades',
          timeLimit: 90,
          points: 30,
          type: MathGameType.crossword,
        ),
        MathQuestion(
          id: 'crossword_2',
          question: 'Número que representa "nada" (4 letras)',
          options: ['UM', 'ZERO', 'DOIS', 'TRÊS'],
          correctAnswer: 'ZERO',
          explanation: 'Zero é o número que representa "nada"',
          timeLimit: 90,
          points: 30,
          type: MathGameType.crossword,
        ),
        MathQuestion(
          id: 'crossword_3',
          question: 'Forma geométrica com 3 lados (8 letras)',
          options: ['QUADRADO', 'TRIÂNGULO', 'CÍRCULO', 'RETÂNGULO'],
          correctAnswer: 'TRIÂNGULO',
          explanation: 'Triângulo é a forma com 3 lados',
          timeLimit: 90,
          points: 30,
          type: MathGameType.crossword,
        ),
        MathQuestion(
          id: 'crossword_4',
          question: 'Resultado de uma multiplicação (7 letras)',
          options: ['SOMA', 'PRODUTO', 'DIFERENÇA', 'QUOCIENTE'],
          correctAnswer: 'PRODUTO',
          explanation: 'Produto é o resultado de uma multiplicação',
          timeLimit: 90,
          points: 30,
          type: MathGameType.crossword,
        ),
        MathQuestion(
          id: 'crossword_5',
          question: 'Parte de um todo (8 letras)',
          options: ['FRACIONA', 'FRACÇÃO', 'FRACÇÃO', 'FRACÇÃO'],
          correctAnswer: 'FRACÇÃO',
